...
const PatientDashboard = () => {
  ...
  const handleFileChange = (e) => {
    ...
    const duplicateMatch = submissions.some(
      (submission) => submission.uploadFingerprint === fingerprint
    );
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
            <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
              ...
              <p className="mt-2 text-sm text-gray-600">
                This file looks like a previous submission. You can cancel or continue if this upload is intentional.
              </p>
              <div className="mt-6 flex justify-end gap-3">
                ...
                <button
                  type="button"
                  onClick={continueDuplicateUpload}
